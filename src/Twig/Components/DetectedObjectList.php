...
namespace Survos\ImgproxyBundle\Twig\Components;

use Survos\ImgproxyBundle\Util\BoundingBoxNormalizer;
 ...
 */
#[AsTwigComponent('DetectedObjectList', template: '@SurvosImgproxy/components/DetectedObjectList.html.twig')]
